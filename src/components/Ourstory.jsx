        ...
        <div className={styles.heroContent}>
          <div className={styles.heroText} data-animate>
            ...
            <p className={styles.heroDescription}>
              ...
              Our journey began with an exclusive tie-up with Radico Khaitan, which is a leading liquor company in India, continuing production for over two decades now. We had also been proudly producing for Tilak Nagar Industries. At present, we manufacture for many other reputed companies such as Mohan Meakin, Chowki Liquors, and Omsons Pvt. Ltd., delivering consistent quality and service.

              With a strong reputation for producing premium liquor across the entire Northeast, our products are distributed in Nagaland, Manipur, Sikkim, Arunachal Pradesh, and beyond. After more than two decades of experience, we have now launched our very own whiskey in the luxury segment under the name Queens Crown. Backed by state-of-the-art infrastructure and a legacy of trust, Seven Sisters Trade and Distilleries remains committed to blending excellence with reliability.
            </p>
